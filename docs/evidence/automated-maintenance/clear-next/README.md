...
| [#17 HIG仕上げ](https://madesk.tail8be30.ts.net/git/openface/clear-next/issues/17) | designer-agent | [#18](https://madesk.tail8be30.ts.net/git/openface/clear-next/pulls/18) | `96113ffb` | 全操作対象を縦横44px以上へ統一 |
