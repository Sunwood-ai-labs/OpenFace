...
export const routes = [
  ...
  { id: 'character-pet-detail', label: 'Codex Pet collection detail', path: '/openface/character-design-images', scrollSelectors: [{ id: 'format-panel', selector: '.openface-character-format-panel' }], focus: 'Eight independently selectable pet packages, manifests, spritesheets, character sheets, QA evidence, and animated preview rendering' },
