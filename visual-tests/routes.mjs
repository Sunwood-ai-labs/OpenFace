...
export const routes = [
  ...
  { id: 'pull-detail', label: 'Pull request detail', path: '/git/openface/pages-starter/pulls/11', scrollSelectors: [{ id: 'changed-files', selector: 'a[href="#changed-files"]' }], focus: 'Pull request title, branch metadata, three-tab navigation, Markdown comment body, and mobile theme contrast' },
