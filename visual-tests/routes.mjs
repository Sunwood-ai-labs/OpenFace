...
export const routes = [
  ...
  { id: 'community-reactions', label: 'Community reactions and events', path: '/git/openface/pages-starter/issues/16', scrollSelectors: [{ id: 'reactions-and-events', selector: '.ui.attached.segment.reactions' }], focus: 'Independent Hugging Face-style reaction pills, borderless reference and commit events, and bordered authored comments across themes' },
