...
export const routes = [
  ...
  { id: 'docs', label: 'Knowledge category home', path: '/docs', focus: 'Overall, Article, Procedure, Wiki, and News sections with independent latest/popular controls, Spaces-style cards, and responsive layout' },
  { id: 'docs-category-sort', label: 'Knowledge category popular sort', path: '/docs?articleSort=trending&newsSort=trending', focus: 'Independent Article and News popular-sort states remain active together without affecting other category sections' },
  ...
  { id: 'character-sheet-detail', label: 'Independent character sheet detail', path: '/openface/momiji-character-sheet', scrollSelectors: [{ id: 'format-panel', selector: '.openface-character-format-panel' }], focus: 'One repository-backed character sheet with export, thumbnail, and rights metadata' },
  ...
  { id: 'organization', label: 'Organization profile', path: '/git/openface', waitUntil: 'domcontentloaded', settleMs: 700, focusSelector: '.openface-org-repo-card a', scrollSelectors: [{ id: 'team-members', selector: '.openface-member-cloud' }], focus: 'Organization hero, safe mobile gutters, real members, repository focus state, and theme contrast' },
  { id: 'organization-seraphim', label: 'Seraphim Labs organization', path: '/git/seraphim-labs', waitUntil: 'domcontentloaded', settleMs: 700, focusSelector: '.openface-org-edit', scrollSelectors: [{ id: 'team-members', selector: '.openface-member-cloud' }], focus: 'Angel-themed organization branding, safe mobile gutters, editable settings action, real members, and mobile theme contrast' },
