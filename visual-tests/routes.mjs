...
export const routes = [
  ...
  { id: 'doc-detail', label: 'Doc detail', path: '/openface/platform-knowledge-atlas', focus: 'Wiki content, topics, repository source actions, responsive reading width, and theme contrast' },
