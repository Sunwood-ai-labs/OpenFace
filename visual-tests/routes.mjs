...
export const routes = [
  ...
  { id: 'benchmark-cad-detail', label: 'CADTestBench detail', path: '/openface/cadtestbench', focus: 'Imported upstream README, executable Text-to-CAD task metadata, benchmark actions, clone control, and tabs' },
  { id: 'benchmark-svg-detail', label: 'SVGenius detail', path: '/openface/svgenius', focus: 'Imported upstream README, SVG understanding/editing/generation metadata, benchmark actions, clone control, and tabs' },
