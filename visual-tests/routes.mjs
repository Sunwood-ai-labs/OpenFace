...
export const routes = [
  ...
  { id: 'pull-detail', label: 'Pull request detail', path: '/git/openface/pages-starter/pulls/2', scrollSelectors: [{ id: 'merge-instructions', selector: '.merge-section' }], focus: 'Pull request title, branch metadata, three-tab navigation, Markdown comment body, timeline events, merge instructions, and mobile theme contrast' },
