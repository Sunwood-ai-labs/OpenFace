...
Forgejo のIssueとPull RequestをOpenFaceのCommunity導線として扱います。スクリーンショットと、ボタン・行・キーボード操作の微細なフィードバック確認は [Community / Issue UI verification](docs/evidence/community-ui/README.md) を参照してください。
